...
class RepositoryBase {
  ...
  Future<LegisElement> add(LegisElement element) async {
    _indexIncrement++;
  ...
  Future<LegisElement> getById(int id) async {
    var map = await store.record(id).get(_db);
    return LegisElement.fromMap(map);
  }
  ...
  Future<void> update(LegisElement element) async {
